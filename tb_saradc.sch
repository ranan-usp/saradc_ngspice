...
C {my_sar_logic.sym} 1580 -700 0 0 {name=x3}
...
C {opin.sym} 1770 -870 0 0 {name=p42 sig_type=std_logic lab=Q00}
...
C {opin.sym} 1770 -850 0 0 {name=p1 sig_type=std_logic lab=Q01}
C {opin.sym} 1770 -830 0 0 {name=p2 sig_type=std_logic lab=Q02}
C {opin.sym} 1770 -810 0 0 {name=p3 sig_type=std_logic lab=Q03}
C {opin.sym} 1770 -790 0 0 {name=p4 sig_type=std_logic lab=Q04}
C {opin.sym} 1770 -770 0 0 {name=p5 sig_type=std_logic lab=Q05}
...
C {lab_wire.sym} 1780 -750 0 1 {name=l1 sig_type=std_logic lab=Sample}
C {lab_wire.sym} 1780 -730 0 1 {name=l2 sig_type=std_logic lab=SW0}
C {lab_wire.sym} 1780 -710 0 1 {name=l3 sig_type=std_logic lab=SW0B}
C {lab_wire.sym} 1780 -690 0 1 {name=l4 sig_type=std_logic lab=SW1}
C {lab_wire.sym} 1780 -670 0 1 {name=l5 sig_type=std_logic lab=SW1B}
C {lab_wire.sym} 1780 -650 0 1 {name=l6 sig_type=std_logic lab=SW2}
C {lab_wire.sym} 1780 -630 0 1 {name=l7 sig_type=std_logic lab=SW2B}
C {lab_wire.sym} 1780 -610 0 1 {name=l8 sig_type=std_logic lab=SW3}
C {lab_wire.sym} 1780 -590 0 1 {name=l9 sig_type=std_logic lab=SW3B}
C {lab_wire.sym} 1780 -570 0 1 {name=l10 sig_type=std_logic lab=SW4}
C {lab_wire.sym} 1780 -550 0 1 {name=l11 sig_type=std_logic lab=SW4B}
C {lab_wire.sym} 1780 -530 0 1 {name=l12 sig_type=std_logic lab=SW5}
C {lab_wire.sym} 1780 -510 0 1 {name=l20 sig_type=std_logic lab=SW5B}
C {gnd.sym} 1040 -750 0 0 {name=l15 lab=GND}
C {not.sym} 1220 -680 0 0 {name=x6}
...
C {xschem_sky130/sky130_fd_pr/cap_mim_m3_1.sym} 1040 -800 0 0 {name=C1 model=cap_mim_m3_1 W=2 L=2.15 MF=1 spiceprefix=X}
C {xschem_sky130/sky130_stdcells/inv_1.sym} 1860 -890 0 0 {name=x4 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {lab_wire.sym} 1930 -890 0 1 {name=l16 sig_type=std_logic lab=COMP_ENB}
C {lab_wire.sym} 760 -160 1 1 {name=l32 sig_type=std_logic lab=COMP_ENB}
C {gnd.sym} 1400 -350 0 0 {name=l26 lab=GND}
C {vsource.sym} 1400 -400 0 0 {name=V1 value="DC pulse(0 1.8 0 30p 30p 5.555n 11.11n)"}
C {lab_wire.sym} 1400 -450 0 0 {name=l33 sig_type=std_logic lab=CLK}
C {lab_wire.sym} 1410 -720 0 0 {name=l34 sig_type=std_logic lab=CLK}
...
C {lab_wire.sym} 1300 -680 0 0 {name=l43 sig_type=std_logic lab=COMP_IN}
