...
C {lab_wire.sym} 420 -500 0 0 {name=l1 sig_type=std_logic lab=CLK}
C {lab_wire.sym} 490 -470 0 0 {name=l6 sig_type=std_logic lab=R}
C {lab_wire.sym} 420 -540 0 0 {name=l7 sig_type=std_logic lab=D}
C {lab_wire.sym} 670 -540 0 1 {name=l8 sig_type=std_logic lab=OUT}
...
C {devices/vsource.sym} 260 -250 0 0 {name=V1 
value=0
*value="pulse 0 1.8 5n .1n .1n 19.9n 40n"}
C {devices/gnd.sym} 260 -220 0 0 {name=l20 lab=GND}
C {devices/lab_pin.sym} 330 -310 0 1 {name=l21 sig_type=std_logic lab=R}
C {my_df.sym} 620 -520 0 0 {name=x1}
C {lab_wire.sym} 650 -500 0 0 {name=l3 sig_type=std_logic lab=CLK}
